    ...
    <Menu closeOnSelect={false}>
        ...
        <MenuList minWidth='240px'>
          <MenuOptionGroup title='Técnicos' type='checkbox'>
            ...
            <MenuItemOption value='Web' onClick={() => handleOptionClick('Web', 'form1')}>Desarrollo Web</MenuItemOption>
            <MenuItemOption value='Imagen Comercial' onClick={() => handleOptionClick('Imagen Comercial', 'form1')}>Imagen Comercial</MenuItemOption>
            <MenuItemOption value='Animación' onClick={() => handleOptionClick('Animación', 'form1')}>Animación 3D</MenuItemOption>
          </MenuOptionGroup>
        </MenuList>
      </Menu>
      <Menu closeOnSelect={false}>
